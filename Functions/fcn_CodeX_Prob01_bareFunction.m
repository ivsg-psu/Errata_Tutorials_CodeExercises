...
function output_string = fcn_CodeX_Prob01_bareFunction(varargin)
%% fcn_CodeX_Prob01_bareFunction
...
% FORMAT:
%
%      output_string = fcn_CodeX_Prob01_bareFunction(input_string,value_to_add,(index))
%
% INPUTS:
%
...
% EXAMPLES:
%
%     See the script: script_test_fcn_CodeX_Prob01_bareFunction
