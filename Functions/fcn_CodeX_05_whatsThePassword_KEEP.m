function true_or_false = fcn_CodeX_05_whatsThePassword(varargin) %#ok<FNDEF> 
...
%   FORMAT:
%
%        true_or_false = fcn_CodeX_05_whatsThePassword(entry_key,student_number,guess)
%
%   INPUTS:
%
...
dependencies = 'fcn_CodeX_04_doubleOrNothing, fcn_CodeX_05_whatsThePassword';
...
this_fname = 'fcn_CodeX_05_whatsThePassword';
