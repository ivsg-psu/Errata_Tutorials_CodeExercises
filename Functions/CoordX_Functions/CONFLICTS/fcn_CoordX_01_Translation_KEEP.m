...
%
%   For translating the points, use --
%   (transformation_matrix*homogenous_random_points')'
%   
%   " ' "  --  Transpose of a matrix Homogenous points: Z - coordinates of
%   the randomly generated points should be '1' To check if the answer is
%   correct, call fcn_GradeCoordX. 
%   
...
%
%            fcn_GradeCoordX('fcn_CoordX_01_Translation',answer_01_closestPoint_Index);
%
...
%            student_number);
%
%   If the answer is correct, the grader prints the information and gives
%   you the next problem.
...
%        numbers used in the fcn_GradeCoordX operations
%
%   OUTPUTS:
%
