function [random_points, moved_points] = fcn_CoordX_09_findAffineTransformMatrix(varargin)
% FCN_COORDX_09_FINDAFFINETRANSFORMMATRIX - Find the 2D homogeneous-form
% transform matrix that fits the points each other
%   
%   Welcome to FCN_COORDX_09_FINDAFFINETRANSFORMMATRIX. In this assignment,
...
%   matching set of points which are the skewed, scaled, rotated and
...
%   
%   [T_calculated,~] =
%   fcn_AlignCoords_fitAffineXform(random_points,
%   moved_points);
%
...
%   fcn_CoordX_09_findAffineTransformMatrix(entry_key,student_number); 
%
...
%            
%            answer_09 = T_calculated
%            fcn_GradeCoordX('fcn_CoordX_09_findAffineTransformMatrix',answer_09);
%
%
...
dependencies = 'fcn_CoordX_08_findHomogeneousTransformMatrix, fcn_CoordX_09_findAffineTransformMatrix';
...
this_fname = 'fcn_CoordX_09_findAffineTransformMatrix';
...
if nargin==nargin_lock_number
    ...
    if strcmp(Grader_input_code,date_lock_value)
        ...
        [T_calculated,~] = fcn_AlignCoords_fitAffineXform(coord_base_points(:,1:2), coord_xform_points(:,1:2)); % Find optimal transform
