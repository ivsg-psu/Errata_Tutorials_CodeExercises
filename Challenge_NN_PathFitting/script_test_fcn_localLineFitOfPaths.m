...
if ~exist('path1')
    ...
    if 1==0  % Build a path
        ...
        [X1,Y1] = ginput;
        path1 = [X1 Y1];
    else  % Load a path from a previous run
        path1 = [
            8.1797    8.6006
            8.4101   15.8892
            10.0230   25.5102
...
%% Save the data into a structure containing arrays of each traversal
...
% Loop through each traversal, and plot the yaw for it
